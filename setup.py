...
setup(
    ...
    download_url='https://github.com/bellhops/django-crud-filters/dist/crud_filters-0.1.0.tar.gz',
    keywords=['django', 'authorization', 'api', 'security'],
    classifiers=[],
    install_requires=['Django', 'djangorestframework', 'djangorestframework-expiring-authtoken'],
)